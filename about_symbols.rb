...
#	  assert_equal true, Symbol.all_symbols.include?(:xyztest_method_names_become_symbols)
  end

  # THINK ABOUT IT:
  #
  # Why do we convert the list of symbols to strings and then compare
  # against the string value rather than against symbols? // because once we try to test with the symbol, the symbol is create, so it 
